            ...
            <li>
              <nuxt-link :to="localePath(`/showcases/${showcases[0]?.slug}`)"
                ><span
                  ...
                  >
                    <path
                      d="M15.7819 3.3837L15.6194 3.30074L14.04 2.37629L10.7652 0.444444C9.76645 -0.148148 8.23355 -0.148148 7.23484 0.444444L3.96 2.36444L2.38065 3.31259L2.17161 3.41926C0.139355 4.81777 0 5.07851 0 7.31853V12.6756C0 14.9156 0.139355 15.1763 2.21806 16.6104L7.23484 19.5615C7.73419 19.8696 8.36129 20 9 20C9.6271 20 10.2658 19.8578 10.7652 19.5615L15.8284 16.5748C17.8723 15.1763 18 14.9274 18 12.6756V7.31853C18 5.07851 17.8606 4.81777 15.7819 3.3837ZM12.24 9.93779L11.5316 10.8267C11.4155 10.957 11.3342 11.2059 11.3458 11.3837L11.4155 12.5215C11.4619 13.2207 10.9742 13.5763 10.3355 13.3274L9.30194 12.9007C9.13935 12.8415 8.87226 12.8415 8.70968 12.9007L7.67613 13.3156C7.03742 13.5763 6.54968 13.2089 6.59613 12.5096L6.66581 11.3719C6.67742 11.1941 6.59613 10.9452 6.48 10.8148L5.76 9.93779C5.31871 9.40446 5.51613 8.81186 6.17806 8.63409L7.25806 8.34964C7.43226 8.30224 7.62968 8.13631 7.72258 7.99409L8.32645 7.04594C8.69806 6.45335 9.29032 6.45335 9.67355 7.04594L10.2774 7.99409C10.3703 8.14816 10.5794 8.30224 10.7419 8.34964L11.8219 8.63409C12.4839 8.81186 12.6813 9.40446 12.24 9.93779Z"
                      fill="#FBC100"
                    /></svg
                ></span>
                {{ showcases[0]?.name }}</nuxt-link
              >
            </li>
            <li>
              <nuxt-link :to="localePath(`/showcases/${showcases[1]?.slug}`)"
                ><span
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
...
export default {
  ...
  async fetch() {
    const [topBarsData, showcasesData] = await Promise.all([
    ...
    this.showcases = showcasesData.showcases;
